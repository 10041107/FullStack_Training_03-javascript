...
// num.__proto__.__proto__ === Object.prototype  || Number.__proto__ == Object.prototype
console.log( num.__proto__.__proto__ === Object.prototype ); // true

// 체인 맨 위엔 null이 있다.
//num.__proto__(number).__proto__(object).__proto__(x) object는 다른 것을 참조하지 않기 대문
...
// JavaScript에서는 모든 객체는 자신의 원형을 가리키는 prototype 링크를 가집니다.
  const obj = {
    0: "Hello",
    1: "JavaScript!",
    length: 2,
